...
export const EVENT_HANDLER_PORT = Number(process.env["EVENT_HANDLER_PORT"] || 8081);
...
export const EVENT_HANDLER_URL = `http://127.0.0.1:${EVENT_HANDLER_PORT}`;
...
// SETUP-DD-TEMP: Add a secret passcode here.
export const REST_AUTHORIZATION = process.env["REST_AUTHORIZATION"] || "testing";

/** The port that will run the REST proxy. */
// SETUP-DD-TEMP: Choose the port number here that will be used for the REST proxy.
export const REST_PORT = Number(process.env["REST_PORT"] || 8000);
